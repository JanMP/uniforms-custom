...
function Text(_a) {
    ...
    return (React.createElement("div", Object.assign({}, filterDOMProps(props)),
        ...
        React.createElement("input", { className: setErrorClass(props), autoComplete: autoComplete, disabled: disabled, id: id, name: name, onChange: event => onChange(event.target.value), placeholder: placeholder, readOnly: readOnly, ref: inputRef, type: type, value: value !== null && value !== void 0 ? value : '' })));
}
