...
function Auto(Base) {
    ...
    class AutoForm extends Base {
        ...
        getNativeFormProps() {
            return omit_1.default(super.getNativeFormProps(), ['onChangeModel']);
        }
        ...
        onChange(key, value) {
            ...
            this.setState(state => ({ model: setWith_1.default(clone_1.default(state.model), key, value, clone_1.default) }), () => {
