...
function LongText(_a) {
    ...
    return (React.createElement("div", Object.assign({}, filterDOMProps(props)),
        ...
        React.createElement("textarea", { className: setErrorClass(props), disabled: disabled, id: id, name: name, onChange: event => onChange(event.target.value), placeholder: placeholder, readOnly: readOnly, ref: inputRef, value: value !== null && value !== void 0 ? value : '' })));
}
