...
function Radio(_a) {
    ...
    return (react_1.default.createElement("div", tslib_1.__assign({}, uniforms_1.filterDOMProps(props)),
        ...
        allowedValues.map(function (item) { return (react_1.default.createElement("div", { key: item },
            react_1.default.createElement("input", { className: setErrorClass_1.default(props), checked: item === value, disabled: disabled, id: id + "-" + escape(item), name: name, onChange: function () { return onChange(item); }, type: "radio" }),
