...
function Date(_a) {
    ...
    return (react_1.default.createElement("div", tslib_1.__assign({}, uniforms_1.filterDOMProps(props)),
        ...
        react_1.default.createElement("input", { className: setErrorClass_1.default(props), disabled: disabled, id: id, max: dateFormat(max), min: dateFormat(min), name: name, onChange: function (event) {
